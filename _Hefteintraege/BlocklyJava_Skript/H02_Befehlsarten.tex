...
%\rotatebox{90}{\LoesungLuecke{einf. Befehl\color{black}}{\lineheight}}
...
\LoesungLuecke{\multicolumn{5}{l}{\color{blue} Verzweigung\color{black}}\\}
...
\LoesungLuecke{\\\multicolumn{5}{l}{\color{blue} Schleife / bedingte Wiederholung\color{black}}\\}
...
\LoesungLuecke{\multicolumn{5}{l}{\color{blue} Zählschleife\color{black}}\\}
...
\LoesungLuecke{\multicolumn{5}{l}{\color{blue} Methodendeklaration\color{black}}\\}
...
\LoesungLuecke{\multicolumn{5}{l}{\color{blue} Methodenaufruf\color{black}}\\}
...
\LoesungLuecke{\\\multicolumn{5}{l}{\color{blue} Kommentar\color{black}}\\}
...
\LoesungLuecke{\\\multicolumn{5}{l}{\color{blue} Konstruktor\color{black}}\\}
...
\LoesungLuecke{\multicolumn{5}{l}{\color{blue} Objekt erstellen\color{black}}\\}
