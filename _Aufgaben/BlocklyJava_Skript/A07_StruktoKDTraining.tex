...
\textbf{\normalsize Setze folgende Diagramme in BlueJ-Blockly um und notiere den Programmcode auf der nächsten Seite}

\vspace{0.5cm}

\doppelseite{0.45}{0.5}{t}{%
\textbf{\normalsize Klassendiagramm:}

\includegraphics[width=\linewidth]{_Aufgaben/BlocksAndJava/img/klasse.png} 
}{%

\textbf{\normalsize Struktogramm für piAusgeben(double x):}
...
\textbf{\normalsize Zeichne hier die Struktogramme für die restlichen Methoden:}
